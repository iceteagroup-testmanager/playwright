...
export function decorateCommand(command: Command, version: string) {
  command
      ...
      .option('--init-ts <path...>', 'path to TypeScript file to add as an initialization script. The script will be compiled and evaluated in every page before any of the page\'s scripts. Can be specified multiple times.')
